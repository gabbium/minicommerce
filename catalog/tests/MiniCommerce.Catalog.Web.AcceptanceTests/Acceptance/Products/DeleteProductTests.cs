...
public class DeleteProductTests(TestFixture fixture) : TestBase(fixture)
{
    ...
    {
        await _steps.GivenAnAuthenticatedUser(PermissionNames.CanCreateProduct, PermissionNames.CanDeleteProduct);
    ...
    {
        await _steps.GivenAnAuthenticatedUser(PermissionNames.CanDeleteProduct);
